      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between mb-8">
          <div className="mb-8 md:mb-0">
            ...
            <p className="text-gray-400 max-w-xs">
              Your ultimate destination for all things anime. Discover, watch, and connect with fellow anime enthusiasts.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><a href="#" className="hover:text-purple-400">Browse Anime</a></li>
                <li><a href="#" className="hover:text-purple-400">New Releases</a></li>
                <li><a href="#" className="hover:text-purple-400">Top Rated</a></li>
                <li><a href="#" className="hover:text-purple-400">Genres</a></li>
              </ul>
            </div>
            <div>
              <h3 className="font-semibold mb-4">Community</h3>
              <ul className="space-y-2 text-gray-400">
                <li><a href="#" className="hover:text-purple-400">Forums</a></li>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm mb-4 md:mb-0">
            © 2025 Anime Babyy. All rights reserved.
          </p>
